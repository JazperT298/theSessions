            ...
            children: [
              ...
              Padding(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    if(userEmailController.text.isNotEmpty || userNameController.text.isNotEmpty || userPasswordController.text.isNotEmpty){
            ...
            children: [
              ...
              Padding(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    if(userEmailController.text.isNotEmpty || userNameController.text.isNotEmpty || userPasswordController.text.isNotEmpty){
                      Provider.of<Authentication>(context, listen: false).logIntoAccount(userEmailController.text, userPasswordController.text)
                      .whenComplete((){
                        Navigator.pushReplacement(context, PageTransition(
                          child: Homepage(),
                          type: PageTransitionType.bottomToTop
